...
public class Languages {
    ...
    private Languages() {
        try {
            PRB_ES = new PropertyResourceBundle(new InputStreamReader(getClass().getResourceAsStream("/mc_es.properties"), StandardCharsets.UTF_8));
            PRB_EN = new PropertyResourceBundle(new InputStreamReader(getClass().getResourceAsStream("/mc.properties"), StandardCharsets.UTF_8));
